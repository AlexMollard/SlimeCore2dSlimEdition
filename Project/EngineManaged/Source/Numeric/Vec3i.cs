...
namespace EngineManaged.Numeric
{
	...
	public struct Vec3i : IEquatable<Vec3i>
	{
		...
		public static Vec3i operator -(Vec3i a, Vec3i b) => new Vec3i(a.X - b.X, a.Y - b.Y, a.Z - b.Z);
		public static Vec3i operator *(Vec3i a, int scalar) => new Vec3i(a.X * scalar, a.Y * scalar, a.Z * scalar);
		public static Vec3i operator *(int scalar, Vec3i a) => new Vec3i(a.X * scalar, a.Y * scalar, a.Z * scalar);
		public static Vec3i operator /(Vec3i a, int scalar) => new Vec3i(a.X / scalar, a.Y / scalar, a.Z / scalar);
		...
		public static explicit operator Vec3i(Vec3 v) => new Vec3i((int)MathF.Round(v.X), (int)MathF.Round(v.Y), (int)MathF.Round(v.Z));
		public Vec3 ToVec3() => new Vec3(X, Y, Z);
		public Vec3 ToVec3Floor() => new Vec3((float)MathF.Floor(X), (float)MathF.Floor(Y), (float)MathF.Floor(Z));
