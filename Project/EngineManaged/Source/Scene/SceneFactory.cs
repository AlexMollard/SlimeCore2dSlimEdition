...
public static class SceneFactory
{
	...
	{
		// We use the ObjectManager_ native call to ensure the engine tracks this entity in its list
		ulong id = Native.ObjectManager_CreateQuad(x, y, width, height, r, g, b);
	...
	{
		ulong id = Native.ObjectManager_CreateQuadWithTexture(x, y, width, height, textureId);
	...
	public static Entity CreateGameObject(float x, float y, float r = 1f, float g = 1f, float b = 1f)
	{
		...
		ulong id = Native.ObjectManager_CreateGameObject(x, y, 1f, 1f, r, g, b);
