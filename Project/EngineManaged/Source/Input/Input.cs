...
internal static class Input
{
    ...
    public static (float x, float y) GetMousePos() { SafeNativeMethods.Input_GetMouseToWorldPos(out var x, out var y); return (x, y); }
    public static (float x, float y) GetMouseScreenPos() { SafeNativeMethods.Input_GetMousePos(out var x, out var y); return (x, y); }
    ...
    public static (float x, float y) GetMouseToWorld() { SafeNativeMethods.Input_GetMouseToWorldPos(out var x, out var y); return (x, y); }
