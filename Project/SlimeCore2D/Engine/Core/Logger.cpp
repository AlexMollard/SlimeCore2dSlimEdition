...
void Logger::Log(LogLevel level, const std::string& message)
{
    ...
    switch (level)
    {
    case LogLevel::Trace: color = 8; levelStr = "TRACE"; break; // Gray
    case LogLevel::Info:  color = 10; levelStr = "INFO "; break; // Green (Bright)
    case LogLevel::Warn:  color = 14; levelStr = "WARN "; break; // Yellow (Bright)
    case LogLevel::Error: color = 12; levelStr = "ERROR"; break; // Red (Bright)
    }
