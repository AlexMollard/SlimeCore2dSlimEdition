...
bool DotNetHost::Init()
{
	...
	rc = load_assembly_and_get_function_pointer(managedDllPath.c_str(), L"ScriptRuntime, EngineManaged", L"Init", UNMANAGEDCALLERSONLY_METHOD, nullptr, (void**) &m_init);
	...
	rc = load_assembly_and_get_function_pointer(managedDllPath.c_str(), L"ScriptRuntime, EngineManaged", L"Update", UNMANAGEDCALLERSONLY_METHOD, nullptr, (void**) &m_update);
